                        ...
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="inbox.php"><div class="sb-nav-link-icon"><i class="fas fa-envelope"></i></div> All Messages</a>
                                    <a class="nav-link" href="inbox-unread.php"><div class="sb-nav-link-icon"><i class="fas fa-envelope"></i></div> Unread Messages</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="posts.php"><div class="sb-nav-link-icon"><i class="fas fa-list"></i></div> All posts</a>
