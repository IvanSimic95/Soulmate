...
$redirectPayment = "https://gabeaff_soulmateps.pay.clickbank.net?cbskin=39040&coupon=deepconnection&coupon_paylink=true&cbitems=".$cbproduct."&name=".$user_name."&email=".$user_email."&cookie_ID=".$cookie_id."&order_ID=".$lastRowInsert;
