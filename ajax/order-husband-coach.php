...
$redirectPayment = "https://fixitcoach_soulmateps.pay.clickbank.net/order/orderform.html?cbskin=39137&cbtimer=1593&cbfid=52075&cbitems=".$cbproduct."&name=".$user_name."&email=".$user_email."&cookie_ID=".$cookie_id."&order_ID=".$lastRowInsert;
$redirectPayment = "https://fixitcoach_soulmateps.pay.clickbank.net/order/?cbskin=39137&cbfid=52260&cbitems=".$cbproduct."&name=".$user_name."&email=".$user_email."&cookie_ID=".$cookie_id."&order_ID=".$lastRowInsert;

$recoverPayment = "https://fixitcoach_soulmateps.pay.clickbank.net/?cbskin=39137&cbfid=52260&cbitems=".$cbproduct."&name=".$user_name."&email=".$user_email."&cookie_ID=".$cookie_id."&order_ID=".$lastRowInsert."&main_ID=".$lastRowInsert."&femail=recovery&coupon=IXTFDDI";
