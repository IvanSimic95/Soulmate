...
<body class="body">
  ...
  <a href="/contact.php" style="color:white;text-decoration:none;">Contact</a>
    ...
    <div class="header-section">
	  ...
	  <div class="w-row">
        <div class="w-col w-col-7 w-col-small-small-stack w-col-tiny-tiny-stack"><center> <img src="/images/sm33.png" loading="lazy" srcset="/images/sm33.png 500w, /images/sm33.png 571w" sizes="100vw" alt="" class="image-mobile"> </center>
...
.text-placeholder{
  ...
  .form-control:active + .icon-inside, 
  .form-control:hover + .icon-inside,
  .form-control:focus + .icon-inside{   
  ...
  .form-control:focus {
    border-color: #ec38bc;
    box-shadow: inset 0 1px 1px rgb(0 0 0 / 8%), 0 0 4px #ec38bc;
  }
#userName{
  ...
  .form-floating>label {
    ...
    .form-floating-icon .icon-inside {
        position: absolute;
        left: 20px;
        top: 17px;
        pointer-events: none;
      ...
      .form-floating-icon input {
       ...
       .form-floating>.form-control:focus~label, .form-floating>.form-control:not(:placeholder-shown)~label, .form-floating>.form-select~label {
        opacity: .65;
        -webkit-transform: scale(0.75) translateY(-0.7rem) translateX(0.15rem);
        -ms-transform: scale(0.75) translateY(-0.7rem) translateX(0.15rem);
        transform: scale(0.75) translateY(-0.7rem) translateX(0.15rem);
    }
    #normalproduct label.error {
      display: block;
      position: relative;
      width: auto;
      color: #8a2134;
    ...
    #normalproduct .error-container {
      padding: 0.5rem;
    border-radius: 0.25rem;
      background-color: #fad7dd;
    border-color: #f8c3cd;
    }
    #normalproduct .error-container ol {
      list-style: disc;
      padding-left: 25px;
    }

    #normalproduct .form-control.is-invalid,
    #normalproduct .form-control.error {
      border-color: #e63757;
    ...
    #normalproduct .form-control.is-valid,
    #normalproduct .form-control.valid {
      border-color: #00d27a;
      padding-left: calc(1.5em + 0.625rem);
...
#delivery-speed > div.btn-group.d-flex > div:nth-child(1) > label,
#delivery-speed > div.btn-group.d-flex > div:nth-child(2) > label,
#delivery-speed > div.btn-group.d-flex > div:nth-child(3) > label{
width:100%;
padding:10px;
}
#delivery-speed > div.btn-group.d-flex > div:nth-child(1) > label{
...
.accordion-header .delivery-title {
font-size:1.2rem;
}
...
.accordion-header .delivery-title .title-text {
display:none;
}
.option .badge {
display:none;
...
[type="radio"] {
  ...
  [type="radio"]:checked ~ label {
    border-color: #e836ba;
    background-color: #ff00d529;
    color: #fff;
  }
  [type="radio"]:checked ~ label .svg-inline--fa{
    color: #e836ba;
  }

  [type="radio"]:checked ~ label .badge{
    background: #03001e;
  ...
  [type="radio"]:checked ~ label > span {
    ...
    border: 0;
    background-image: linear-gradient(to top right, #6c03b7, #e836ba);
...
.option{
  ...
  .option .card {
    ...
    padding: 22px 24px;
    border-radius: 16px;
    box-shadow: 0 1px 0 0 rgba(215, 17, 255, 0.25);
...
[type="radio"]:checked ~ label .delivery-icon {
    color: #e836ba;
}
...
<br>
        ...
        <div class="w-col w-col-5 w-col-small-small-stack w-col-tiny-tiny-stack"><img src="/images/sm33.png" loading="lazy" srcset="/images/sm33.png 500w, /images/sm33.png 571w" sizes="100vw" alt="" class="image-desktop">
