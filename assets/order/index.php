...
/*
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://www.soulmate-psychic.com/assets/order/func/start-orders.php');
...
$ch2 = curl_init();
curl_setopt($ch2, CURLOPT_URL, 'https://www.soulmate-psychic.com/assets/order/func/complete-orders.php');
